...
import { Citrus, HomeIcon, LucideBellRing, Users2Icon } from "lucide-react";
...
export const Sidebar = () => {
    ...
    return (<>
        <aside className="w-70 bg-base-200 border-r border-base-300 hidden lg:flex flex-col h-screen sticky top-0">
                ...
                <Link to="/"
                 ...
                 <Link to="/notifications"
                    className={`btn btn-ghost justify-start w-full gap-3 px-3 normal-case ${currentPath==="/notifications"?"btn-active":""}`}>
                        <LucideBellRing className="size-5 text-base-content opacity-70"/>
